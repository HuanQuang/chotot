        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="94" height="31.878260869565214" viewBox="0 0 115 39">
            <defs>
                <linearGradient id="a" x1="49.98%" x2="49.98%" y1="0%" y2="100%">
                    <stop offset="0%" stop-color="#257DB0"></stop>
                    <stop offset="21%" stop-color="#3C90B3"></stop>
                    <stop offset="74%" stop-color="#73BDB9"></stop>
                    <stop offset="100%" stop-color="#89CEBC"></stop>
                </linearGradient>
                <linearGradient id="b" x1="0%" y1="50.02%" y2="50.02%">
                    <stop offset="0%" stop-color="#51BFAC"></stop>
                    <stop offset="100%" stop-color="#DEE899"></stop>
                </linearGradient>
                <linearGradient id="c" x1="50.016%" x2="50.016%" y1="0%" y2="100%">
                    <stop offset="0%" stop-color="#EB403D"></stop>
                    <stop offset="19%" stop-color="#D64252"></stop>
                ...
                <linearGradient id="d" x1="49.972%" x2="49.972%" y1="0%" y2="100%">
                    <stop offset="0%" stop-color="#F48779"></stop>
                    <stop offset="61%" stop-color="#FAB076"></stop>
                    <stop offset="100%" stop-color="#FDC674"></stop>
                </linearGradient>
            </defs>
            <g fill="none" fill-rule="nonzero">
                <path
